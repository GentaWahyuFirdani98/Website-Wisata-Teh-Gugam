...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('galeri.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-4">
                ...
                <div class="flex justify-between mt-4">
                    <a href="{{ route('galeri.edit', $galeri->id) }}" class="text-blue-600 hover:text-blue-800">
                        <i class="fas fa-edit"></i>
                    </a>
                    <form action="{{ route('galeri.destroy', $galeri->id) }}" method="POST" onsubmit="return confirm('Hapus foto ini?')">
                        @csrf
                        @method('DELETE')
